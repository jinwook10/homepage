        ...
        <ol class="breadcrumb text-wrap">
            ...
            <li class="breadcrumb-item active dropdown" aria-current="page">
                <a href="#" class="dropdown-toggle " data-bs-toggle="dropdown"
                   id="mobile-side-dropdown-1" style="color: #1a73e8;">단말기 서비스
                </a>
...
<div class="container" style="padding-bottom: 3rem">
    ...
    <div class="row" style="justify-content: center">
        <div class="col-md-4">
            <img src="/img/homepage/service/terminal.jpg" class="img-thumbnail serviceImg" alt="포스기1">
            <h3 style="text-align: center">단말기 mk1</h3>
            <p>포스의 장점 및 특징, 주로 사용하는 매장유형, 간략한 스펙</p>
        </div>
        <div class="col-md-4">
            <img src="/img/homepage/service/terminal.jpg" class="img-thumbnail serviceImg" alt="포스기2">
            <h3 style="text-align: center">단말기 mk2</h3>
            <p>포스의 장점 및 특징, 주로 사용하는 매장유형, 간략한 스펙</p>
        </div>
    </div>
    <div class="row" style="justify-content: center">
        <div class="col-md-4">
            <img src="/img/homepage/service/terminal.jpg" class="img-thumbnail serviceImg" alt="포스기3">
            <h3 style="text-align: center">단말기 mk3</h3>
            <p>포스의 장점 및 특징, 주로 사용하는 매장유형, 간략한 스펙</p>
        </div>
        <div class="col-md-4">
            <img src="/img/homepage/service/terminal.jpg" class="img-thumbnail serviceImg" alt="포스기4">
            <h3 style="text-align: center">단말기 mk4</h3>
            <p>포스의 장점 및 특징, 주로 사용하는 매장유형, 간략한 스펙</p>
        </div>
    </div>
</div>
