...
<div class="container" style="padding-bottom: 2rem">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    ...
                    <%-- 아코디언 1페이지 끝 --%>
                    <%-- 아코디언 2페이지 --%>
                    <div class="accordion d-none" id="accordion-2">
                        <div class="accordion-item mb-3">
                            <h5 class="accordion-header" id="headingOne-2">
                                <button class="accordion-button border-bottom font-weight-bold" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#collapseOne-2" aria-expanded="true"
                                        aria-controls="collapseOne">
                                    POS 전원이 켜지지 않습니다.2
                                    <i class="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0"></i>
                                    <i class="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0"></i>
                            ...
                            <div id="collapseOne-2" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body text-sm opacity-8">
                                    <div class="faq-page-1">
                                        먼저 포스를 연결하는 선들이 제대로 결속되어 있는지, 전원 램프가 켜져있는지 확인 해 주세요.
                                        문제가 없음에도 POS 전원이 켜지지 않을경우 별도의 점검이 필요합니다.2
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3">
                            <h5 class="accordion-header" id="headingTwo-2">
                                <button class="accordion-button border-bottom font-weight-bold" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#collapseTwo-2"
                                        aria-expanded="false" aria-controls="collapseTwo">
                                    POS 프린터 출력이 되지 않습니다.2
                                    <i class="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0"></i>
                                    <i class="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0"></i>
                                </button>
                            </h5>
                            <div id="collapseTwo-2" class="accordion-collapse collapse" aria-labelledby="headingTwo-2"
                                ...
                                <div class="accordion-body text-sm opacity-8">
                                    먼저 프린터를 연결하는 선들이 제대로 결속되어 있는지, 전원 램프가 켜져있는지 확인 해 주세요.
                                    전원이 켜져있어도 출력이 되지않는 경우에는 커버를 열어 내부 이물질이 있나 확인해 주세요.
                                    문제가 없음에도 출력이 되지 않을시 별도의 점검이 필요합니다.2
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3">
                            <h5 class="accordion-header" id="headingThree-2">
                                <button class="accordion-button border-bottom font-weight-bold" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#collapseThree-2"
                                        aria-expanded="false" aria-controls="collapseThree">
                                    카드를 삽입해도 반응이 없습니다.2
                                    <i class="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0"></i>
                                    <i class="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0"></i>
                            ...
                            <div id="collapseThree-2" class="accordion-collapse collapse"
                                 aria-labelledby="headingThree-2" data-bs-parent="#accordion-2">
                                <div class="accordion-body text-sm opacity-8">
                                    신용카드 리더기에는 일반MSR과 보안MSR이 있습니다.
                                    일반MSR은 마그네틱 카드를 긁어서 카드번호를 입력하고,보안MSR은 IC카드를 꼽아서 카드번호를 입력합니다.
                                    일반MSR의 경우, 메모장에서 카드를 리딩했을 시 카드정보가 입력되는지 확인해보시길 바라며,
                                    보안MSR의 경우 제어판 > 장치관리자 > Port 에서 장치인식이 되어있고 프로그램에서 올바른 포트와 통신속도로 설정됐는지 확인합니다.
                                    설정이 올바름에도 불구하고 리딩이 안 된다면 별도의 점검이 필요합니다.2
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item mb-3">
                            <h5 class="accordion-header" id="headingFour-2">
                                <button class="accordion-button border-bottom font-weight-bold" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#collapseFour-2"
                                        aria-expanded="false" aria-controls="collapseFour">
                                    고객표시화면이 한쪽으로 쏠려서 보여집니다.2
                                    <i class="collapse-close fa fa-plus text-xs pt-1 position-absolute end-0"></i>
                                    <i class="collapse-open fa fa-minus text-xs pt-1 position-absolute end-0"></i>
                                </button>
                            </h5>
                            <div id="collapseFour-2" class="accordion-collapse collapse" aria-labelledby="headingFour-2"
                                ...
                                <div class="accordion-body text-sm opacity-8">
                                    해당 증상은 듀얼 모니터 장비의 디스플레이 표시 좌표가 변경되어 발생할 수 있습니다.
                                    듀얼 모니터 쪽에서 화면을 바라볼때 우측 뒷면에 전원/초점 초기화 버튼이 있습니다.
                                    해당 버튼을 눌러 재부팅/초기화 해보시길 바라며, 이후에 동일증상 발생시 별도의 점검이 필요합니다.2
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination pagination-secondary" style="justify-content: center">
<%--            <li class="page-item">--%>
...
<%--                </a>--%>
<%--            </li>--%>
            <li class="page-item active" id="page-1"><a class="page-link" href="javascript:pageChange(1);">1</a></li>
            <li class="page-item" id="page-2"><a class="page-link" href="javascript:pageChange(2);">2</a></li>
<%--            <li class="page-item">--%>
